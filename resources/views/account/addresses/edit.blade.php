...
@section('title', 'Edit Alamat | RÉUTILISER')
...
<div class="max-w-2xl mx-auto px-margin-mobile md:px-margin-desktop py-8">
    ...
    <h1 class="font-headline-md text-headline-md text-primary mb-8">Edit Alamat</h1>

    <div class="bg-surface border border-outline-variant p-8">
        <form method="POST" action="{{ route('account.alamat.update', $alamat) }}" class="space-y-5">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input id="label" type="text" name="label" value="{{ old('label', $alamat->label) }}" required
                ...
                <div>
                    ...
                    <input id="recipient_name" type="text" name="recipient_name" value="{{ old('recipient_name', $alamat->recipient_name) }}" required
                ...
                <div>
                    ...
                    <input id="phone" type="text" name="phone" value="{{ old('phone', $alamat->phone) }}" required
            ...
            <div>
                ...
                <textarea id="address" name="address" rows="3" required
                          class="w-full bg-transparent border border-outline-variant px-4 py-3 font-body-md text-body-md text-on-background focus:border-primary focus:ring-1 focus:ring-primary outline-none @error('address') border-error @enderror">{{ old('address', $alamat->address) }}</textarea>
            ...
            <div>
                ...
                <input id="district" type="text" name="district" value="{{ old('district', $alamat->district) }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input id="city" type="text" name="city" value="{{ old('city', $alamat->city) }}" required
                ...
                <div>
                    ...
                    <input id="province" type="text" name="province" value="{{ old('province', $alamat->province) }}" required
                ...
                <div>
                    ...
                    <input id="postal_code" type="text" name="postal_code" value="{{ old('postal_code', $alamat->postal_code) }}" required
            ...
            <div class="flex items-center gap-2">
                <input type="checkbox" name="is_default" id="is_default" value="1" {{ old('is_default', $alamat->is_default) ? 'checked' : '' }}
