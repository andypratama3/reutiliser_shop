            ...
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="material" class="form-control @error('material') is-invalid @enderror" value="{{ old('material', $product->material) }}" placeholder="Contoh: Denim, Cotton, Silk">
